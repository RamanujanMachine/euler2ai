...
CORRECT_VARIABLES_DATAFRAME_FILE = r"\filtered_df_with_mathematica_strings_+_correct_variables_0-154047.pkl" # input, change this to the correct file
OUTPUT_DIR = r"C:\Users\totos\Desktop\9 - arXiv_equations_as_recurrences\recurrences_0-154047" # output, change this to the correct directory
