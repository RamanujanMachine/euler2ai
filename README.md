...
The resuling graph is a forest in which each tree represents a clique of equivalent formulas and the edges contain the transformation from one formula to the other (the full cliques are not computed for efficiency).
